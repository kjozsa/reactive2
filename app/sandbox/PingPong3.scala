...
object PingPong3 extends App {
  ...
  class Game extends Actor {
    ...
    def receive = {
      ...
      case SimulateFailure => {
        ...
        context.children.headOption map (_ ! SimulateFailure)
      }
    }
  }
  ...
  List(600, 1200, 1800).foreach(
    sleep(_)(game ! SimulateFailure)
  )
  ...
  def sleep(time: Long)(block: => Any) = Try(Thread.sleep(time)).foreach(_ => block)
}
